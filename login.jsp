    ...
    <div class="container">
        ...
        <form action="login" method="post">
            <div class="form-group mb-2">
                ...
                <small id="emailHelp" class="form-text text-muted">&nbsp;&nbsp;Demo email : admin@flyaway.com</small>
            </div>
            <div class="form-group mx-sm-3 mb-2">
                <label for="inputPassword" class="sr-only">Password</label>
                <input type="password" name="passwordEntered" class="form-control" id="inputPassword" placeholder="Password">
                <small id="passwordHelp" class="form-text text-muted">&nbsp;&nbsp;Default password : Admin</small>
            </div>
